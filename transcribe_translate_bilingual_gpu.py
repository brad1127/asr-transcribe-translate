...
def main() -> None:
    ...
    parser.add_argument("--whisper-device", default="cuda", choices=("cuda", "cpu"))
    parser.add_argument("--whisper-compute-type", default="float16")
    parser.add_argument("--gpu-layers", type=int, default=999, help="llama.cpp layers to offload to GPU")
    ...
    try:
        ...
        print(
            f"Transcribing English with Whisper ({args.whisper_device}, {args.whisper_compute_type})...",
            flush=True,
        )
